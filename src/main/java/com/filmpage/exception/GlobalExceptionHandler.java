...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<?> FilmNotFound(FilmNotFound fnf) {
    ...
    public ResponseEntity<?> WrongRatingValue(WrongRatingValue wrv) {
        ErrorDetails errorDetails = new ErrorDetails();
    ...
    public ResponseEntity<?> FilmVariableNull(FilmVariableNull fvn) {
        ErrorDetails errorDetails = new ErrorDetails();
        errorDetails.setStatusCode(HttpStatus.BAD_REQUEST.value());
        errorDetails.setStatus(HttpStatus.BAD_REQUEST.name());
